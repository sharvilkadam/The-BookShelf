...
{
	$image=$_GET['photo'];
	$query1=mysql_query("SELECT * FROM sellbook WHERE image='$image' ");
...
<table id="ebooks"> 
<tr>
<td style="padding-right:6%"><a href="profilepage.php"><input type="button" value="Back..." class="download"></input></a></td>
<td><a href="removeusedbook.php?photo=<?php echo $image;?>"><input type="button" value="Confirm Remove" class="download"></input></a></td>
</tr>
<tr>
